          ...
          <View style={globalStyles.titleview}>
            ...
            <View style={styles.center}>
              <TouchableOpacity style={styles.input} onPress={() => setModalVisible(true)} >
                  <Text></Text>
                  <Text style={{textAlign:'center',alignItems:'center'}}>{user?.name}</Text>
                  <Image source={lapiz} style={{width:24,height:24}}></Image>
              </TouchableOpacity>
              <TouchableOpacity style={styles.prompt} onPress={() => setModalVisible1(true)}>
                <View style={[globalStyles.btnyellow]}>
                  <Text style={[styles.negrita, globalStyles.white]}>Cambiar contraseña</Text>
                </View>
              </TouchableOpacity >
              <TouchableOpacity style={styles.prompt} onPress={() => setModalVisible2(true)}>
                <View style={[globalStyles.btnyellow]}>
                  <Text style={[styles.negrita, globalStyles.white]}>Eliminar cuenta</Text>
                </View>
              </TouchableOpacity>
            </View>
        <Modal 
        ...
        onRequestClose={() => {setModalVisible1(!modalVisible1)}}>
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <TextInput style={styles.input} placeholder="Nueva contraseña"></TextInput>
              <TextInput style={styles.input} placeholder="Repetir contraseña"></TextInput>
                <View style={styles.flex}>
                  <Pressable onPress={()=> {setModalVisible1(!modalVisible1)}} style={styles.buttonpop1}>
                    <Text style={styles.negrita}>Cancelar</Text>
                  </Pressable>
                  <Pressable onPress={()=> {}} style={styles.buttonpop}>
                    <Text style={[styles.negrita, globalStyles.white]}>Confirmar</Text>
                  </Pressable>
                </View> 
            </View>
          </View>
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={styles.negrita}>¿Desea eliminar la cuenta?</Text>
                ...
                <View style={styles.flex}>
                  <Pressable onPress={()=> {setModalVisible2(!modalVisible2)}} style={styles.buttonpop1}>
                    <Text style={styles.negrita}>Cancelar</Text>
                  </Pressable>
                  <Pressable onPress={()=> {}} style={styles.buttonpop}>
                    <Text style={[styles.negrita, globalStyles.white]}>Eliminar</Text>
                  </Pressable>
                </View> 
            </View>
          </View>
